 ...
 * @since 1.0.0
 */
public interface PeriodFileConfigManager{

    /**
     * 条件查询列表
     */
    @EsbServiceMapping(trancode="8005080201",caption="主键查询固定期文件报表配置")
    List<PeriodFileConfig> getPeriodFileConfigs(
    ...
    PeriodFileConfig getPeriodFileConfig(@ServiceParam(name="periodFileId") String id);
    ...
    PagerRecords getPagerPeriodFileConfigs(Pager pager,//分页条件
    ...
    PeriodFileConfig savePeriodFileConfig(PeriodFileConfig o);
    ...
    void removePeriodFileConfig(@ServiceParam(name="periodFileId") String id);
}
