 ...
 * @since 1.0.0
 */
public interface MetaCategoryManager{

    /**
     * 条件查询列表
     */
    @EsbServiceMapping(trancode="8001090201",caption="主键查询分类属性")
    List<MetaCategory> getMetaCategorys(
    ...
    MetaCategory getMetaCategory(@ServiceParam(name="id") String id);
    ...
    PagerRecords getPagerMetaCategorys(Pager pager,//分页条件
    ...
    MetaCategory saveMetaCategory(MetaCategory o);
    ...
    void removeMetaCategory(@ServiceParam(name="id") String id);
}
