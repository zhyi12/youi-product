 ...
 * @since 1.0.0
 */
public interface MetaAttrManager{

    /**
     * 条件查询列表
     */
    @EsbServiceMapping(trancode="8001090101",caption="主键查询时间属性")
    List<MetaAttr> getMetaAttrs(
    ...
    MetaAttr getMetaAttr(@ServiceParam(name="id") String id);
    ...
    PagerRecords getPagerMetaAttrs(Pager pager,//分页条件
    ...
    MetaAttr saveMetaAttr(MetaAttr o);
    ...
    void removeMetaAttr(@ServiceParam(name="id") String id);
}
