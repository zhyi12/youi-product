 ...
 */
package org.youi.metadata.metadimension.service;
 ...
 * @since 1.0.0
 */
public interface MetaCategoryItemManager{

    /**
     * 条件查询列表
     */
    @EsbServiceMapping(trancode="8001090301",caption="主键查询分类项")
    List<MetaCategoryItem> getMetaCategoryItems(
    ...
    MetaCategoryItem getMetaCategoryItem(@ServiceParam(name="id") String id);
    ...
    PagerRecords getPagerMetaCategoryItems(Pager pager,//分页条件
    ...
    MetaCategoryItem saveMetaCategoryItem(MetaCategoryItem o);
    ...
    void removeMetaCategoryItem(@ServiceParam(name="id") String id);
}
