 ...
 * @since 1.0.0
 */
public interface MeasureUnitManager{

    /**
     * 条件查询列表
     */
    @EsbServiceMapping(trancode="8004020101",caption="主键查询计量单位")
    ...
    MeasureUnit getMeasureUnit(@ServiceParam(name="id") String id);
    ...
    PagerRecords getPagerMeasureUnits(Pager pager,//分页条件
    ...
    MeasureUnit saveMeasureUnit(MeasureUnit o);
    ...
    void removeMeasureUnit(@ServiceParam(name="id") String id);
    ...
    List<MeasureUnit> searchByTerm(@ServiceParam(name = "term") String term);
}
