 ...
 */
package org.youi.server.caller;
 ...
 * <p>@创建时间： 上午11:48:47</p>
 */
@Configuration("server.caller.config")
@Module(name = "server.caller",caption = "server.caller")
@ComponentScan(basePackages = {"org.youi.server.caller.service"})
