...
public class AgencyManagerTest{
    ...
    @Before
    public void setup(){
        PropertyUtils.setPropertyValue(agencyManager,"agencyDao",agencyDao);
    }
    /***************************************saveAgency交易的测试用例***************************************/
    /**
    * @Story			savePage	           保存
    * @Case			    04_001 testSaveAgency
    * @Description
    */
    @Test
    ...
    /**
    * @Story			savePage	           保存
    * @Case			    05_001 testRemoveAgency
    * @Description
    */
    @Test
    public void testRemoveAgency(){
        String agencyId = "id";
        agencyManager.removeAgency(agencyId);
        verify(agencyDao, times(1)).remove(agencyId);
    }
