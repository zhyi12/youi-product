...
public interface UserDataManager{
     ...
     * 条件查询列表
     */
    @EsbServiceMapping(trancode="9001020501",caption="主键查询用户数据")
    ...
    UserData getUserData(@ServiceParam(name="id") String id);
    ...
    PagerRecords getPagerUserDatas(Pager pager,//分页条件
    ...
    UserData saveUserData(UserData o);
    ...
    void removeUserData(@ServiceParam(name="id") String id);
}
