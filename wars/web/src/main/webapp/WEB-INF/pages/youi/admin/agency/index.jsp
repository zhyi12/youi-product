...
<youi:page caption="机构管理">
	...
	<youi:grid id="grid_agency" src="/baseServices/services/agencyManager/getPagerAgencys.json" 
		removeSrc="/baseServices/services/agencyManager/removeAgency.json" idKeys="id"
